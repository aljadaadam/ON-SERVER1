...
// Dark Theme Colors
// ============================================
val PrimaryDark = Color(0xFF1A1A2E)        // Dark background
val OnPrimaryDark = Color(0xFFF5F5F5)      // Light text on dark
val SurfaceDark = Color(0xFF16213E)        // Dark surface
val BackgroundDark = Color(0xFF0F0F23)     // Very dark background
val CardDark = Color(0xFF1F2937)           // Dark cards

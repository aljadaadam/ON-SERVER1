...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gray-50 dark:bg-dark-bg border-l border-gray-200 dark:border-dark-border min-h-screen flex flex-col transition-colors duration-300">
      {/* Logo */}
